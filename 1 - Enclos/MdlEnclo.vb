            ...
            Try
                ...
                With .Enclos
                    ...
                    If CInt(separateData(1)) > 0 Then
                        ...
                        Dim prix As String = StrReverse(separateData(1))
                        Dim prixFinal As String = ""

                        For i = 1 To prix.Count Step 3

                            prixFinal &= Mid(prix, i, 3) & "."

                        Next

                        LinaBot.sendMsg("```Serveur : " & Comptes(index).Personnage.Serveur & vbCrLf &
                                    "Guilde : " & separateData(4) & vbCrLf &
                                    "Prix : " & Mid(StrReverse(prixFinal), 2) & vbCrLf &
