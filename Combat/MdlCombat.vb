Module MdlCombat
    ...
    Sub GiCombatRejoindreImpossible(ByVal index As Integer, ByVal data As String)
        ...
        With Comptes(index)
            ...
            Catch ex As Exception
                ...
                ErreurFichier(index, .Personnage.NomDuPersonnage, "GiCombatRejoindreImpossible", data & vbCrLf & ex.Message)
