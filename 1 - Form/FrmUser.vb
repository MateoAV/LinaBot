...
#Region "Button"
    ...
    Private Sub Button7_Click(sender As Object, e As EventArgs) Handles Button7.Click
        ...
        Dim newGuilde As New FrmGuilde
        newGuilde.Index = index
        newGuilde.Show()
    ...
    Private Sub Button1_Click_1(sender As Object, e As EventArgs)
        ...
        Dim newf As New FunctionMap
        Task.Run(Function() newf.Deplacement(index, "Bas"))
        Return
        MsgBox(Convert.ToInt64("32b", 16))
        Return
        ' LinaBot.sendMsgPrivate("yo", "292600390212648961")
        flushmem()
        MsgBox(Date.Now.AddMinutes("187"))
    End Sub


    Private Declare Function SetProcessWorkingSetSize Lib "kernel32.dll" (ByVal hProcess As IntPtr, ByVal dwMinimumWorkingSetSize As Int32, ByVal dwMaximumWorkingSetSize As Int32) As Int32

    Public Shared Sub flushmem()
        GC.Collect()
    ...
    Private Sub Button_Ami_Click(sender As Object, e As EventArgs) Handles Button_Ami.Click

        Dim newAmi As New FrmAmi
        newAmi.Index = index
        newAmi.Show()
