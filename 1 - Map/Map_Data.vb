...
#Region "Information"
    ...
    Sub GiMapDeplacementEntiteEscalieTeleportation(ByVal index As Integer, ByVal data As String)
    ...
    Sub GiMapDeplacementEntiteTeleportation(ByVal index As Integer, ByVal data As String)
    ...
    Public Sub GiMapAgression(index As Integer, data As String)
