...
#Region "Parler"
    ...
    ''' </returns>
    Public Function QuitteDialogue(ByVal index As String)
...
#Region "Acheter/Vendre"
    ...
    ''' </returns>
    Public Function AcheterVendre(ByVal index As Integer, ByVal nomID As String) As Boolean
    ...
    ''' </returns>
    Public Function QuitteAcheterVendre(ByVal index As Integer) As Boolean
    ...
    ''' </returns>
    Public Function AcheterVendreVendItem(ByVal index As Integer, ByVal nomID As String, ByVal quantite As Integer, Optional ByVal caracteristique As ClassItemCaractéristique = Nothing) As Boolean
                    ...
                    For Each pair As ClassItem In CopyItem(index, .Inventaire).Values
                        ...
                        If pair.Nom.ToLower = nomID.ToLower OrElse pair.IdObjet = nomID Then
                            ...
                            If IsNothing(caracteristique) OrElse ComparateurCaractéristiqueObjets(pair.Caractéristique, caracteristique) Then
                                ...
                                If quantite > pair.Quantité Then quantite = pair.Quantité

                                .Pnj.Bloque.Reset()

                                .Send("ES" & pair.IdUnique & "|" & quantite, True)
    ...
    ''' </returns>
    Public Function AcheterVendreAcheteItem(ByVal index As Integer, ByVal nomID As String, ByVal quantite As Integer, Optional ByVal caracteristique As ClassItemCaractéristique = Nothing) As Boolean
                    ...
                    For Each pair As KeyValuePair(Of Integer, CPnjAcheterVendre) In .Pnj.AcheterVendre
                        ...
                        If pair.Value.ID = nomID OrElse VarItems(pair.Key).Nom.ToLower = nomID.ToLower Then
                            ...
                            If IsNothing(caracteristique) OrElse ComparateurCaractéristiqueObjets(pair.Value.Caracteristique, caracteristique) Then
                                ...
                                .Send("EB" & pair.Key & "|" & quantite, True)
...
#Region "Vendre"
    ...
    ''' </returns>
    Public Function VendreItem(ByVal index As Integer, ByVal nomID As String, ByVal quantite As Integer, ByVal prix As Integer, Optional ByVal caracteristique As ClassItemCaractéristique = Nothing) As Boolean
                    ...
                    If Pair.Nom.ToLower = nomID.ToLower OrElse Pair.IdObjet.ToString = nomID Then
                        ...
                        If Pair.Equipement = "" Then
                            ...
                            If IsNothing(caracteristique) OrElse ComparateurCaractéristiqueObjets(Pair.Caractéristique, caracteristique) Then
                                ...
                                If quantite > CInt(Pair.Quantité) Then
    ...
    ''' </returns>
    Public Function Retirer(ByVal index As String, ByVal nomID As String, ByVal quantite As String, Optional ByVal caracteristique As ClassItemCaractéristique = Nothing) As Boolean
    ...
    ''' </returns>
    Public Function Selectionne(ByVal index As Integer, ByVal nomID As String, Optional ByVal caracteristique As ClassItemCaractéristique = Nothing) As Boolean
...
#Region "Acheter"
    ...
    ''' </returns>
    Public Function AcheterItem(ByVal index As Integer, ByVal nomID As String, ByVal quantite As Integer, ByVal prix As Integer, Optional ByVal caracteristique As ClassItemCaractéristique = Nothing) As Boolean
