...
#Region "Ajoute"
    ...
    Sub GiItemAjoute(ByVal index As Integer, ByVal data As String, ByVal dico As Dictionary(Of Integer, ClassItem))
    ...
    Sub GiBonusEquipementAjoute(ByVal index As Integer, ByVal data As String)
        ...
        With Comptes(index)
            ...
            Try
                ...
                Dim newBonus As New ClassBonusEquipement
    ...
    Public Sub GiInventaireItemAjouteEchange(ByVal index As Integer, ByVal data As String, ByVal dico As Dictionary(Of Integer, ClassItem))
        ...
        With Comptes(index)
            ...
            If ItemExist(index, separateData(0), separateData(1), dico) = False Then
                ...
                dico(separateData(0)).Quantité = separateData(1)
    ...
    Public Sub GiInventaireItemAjouteMarchandise(ByVal index As Integer, ByVal data As String, ByVal dico As Dictionary(Of Integer, ClassItem))
        ...
        With Comptes(index)
            ...
            If ItemExist(index, separateData(0), separateData(1), dico) = False Then
                ...
                With newItem
                    ...
                    .Catégorie = VarItems(separateData(2)).Catégorie
    ...
    Private Function ItemExist(ByVal index As Integer, ByVal idUnique As String, ByVal quantity As String, ByVal dico As Dictionary(Of Integer, ClassItem)) As Boolean

        With Comptes(index)

            If dico.ContainsKey(idUnique) Then

                dico(idUnique).Quantité = quantity
...
#Region "Supprime"
    ...
    Public Sub GiInventaireItemSupprimeEchange(ByVal index As Integer, ByVal data As String, ByVal dico As Dictionary(Of Integer, ClassItem))
    ...
    Public Sub GiInventaireItemSupprimeMarchandise(ByVal index As Integer, ByVal data As String, ByVal dico As Dictionary(Of Integer, ClassItem))
...
#Region "Function"
    ...
    Public Function ItemCaractéristique(ByVal caracteristique As String) As ClassItemCaractéristique
        ...
        Dim resultat As New ClassItemCaractéristique
    ...
    Public Function ComparateurCaractéristiqueObjets(ByVal Item As ClassItemCaractéristique, ByVal Voulu As ClassItemCaractéristique) As Boolean
